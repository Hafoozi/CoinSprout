...
import GoalNewClient from './goal-new-client'

export const metadata: Metadata = {
  title: 'Create Goal — CoinSprout',
}
...
export default async function NewGoalPage({
  ...
  return (
    <div className="space-y-6 py-6">
      ...
      <h1 className="text-xl font-bold text-gray-800">New Goal for {child.name}</h1>

      <div className="card-surface p-5">
        <GoalNewClient childId={childId} redirectTo={ROUTES.PARENT.CHILD(childId)} />
      </div>
    </div>
  )
}
